# Script to calculate storm-centered precipitation quantities for V1
# Like Storm_Centered_Plots but for files that are on Flurry and have different name.
# Rick Russotto, started 12 January 2021
...
dict_arrays = {'v1': {'prec': np.zeros((61, 61, num_storms['v1']))}} 

#Paths to the NetCDF files
paths = {'v1': '/sc3/russotto/nc_daily_concatenated/'}
...
for v in ['v1']: 
    ...
    ds_merged.to_netcdf('storm_centered_peak_intensity_prec_'+v+'.nc')
